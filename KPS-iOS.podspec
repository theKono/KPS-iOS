#
#  Be sure to run `pod spec lint KPS-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "mingshing" => "mingshing.kuo@thekono.com" }
  # Or just: spec.author    = "mingshing"
  # spec.authors            = { "mingshing" => "kuokuo321@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/mingshing"
  ...
  spec.source       = { :git => "https://github.com/theKono/KPS-iOS.git", :tag => "#{spec.version}" }
